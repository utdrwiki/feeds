/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fe8cbaa49214af1f6b2ba934a7e1fba9)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PIPELINE">> {}
}
